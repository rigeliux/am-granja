                    ...
                    <div class="row-fluid">
                        <div class="span6">
                            <div class="control-group">
                                <label>Nombre</label>
                                <input type="text" placeholder="Nombre del privilegio" class="span12" name="privilegio[nombre]" data-rule-required="true">
                            </div>
                        </div>
                        <div class="span6">
                            <div class="control-group">
                                <label>Descripcion</label>
                                <input type="text" placeholder="Descripción" class="span12" name="privilegio[descripcion]" >
                            </div>
                        </div>
					</div>
